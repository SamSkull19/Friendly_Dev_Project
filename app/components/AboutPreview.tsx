...
const AboutPreview = () => {
    return (
        <section className='mt-12 p-10 rounded-xl flex flex-col md:flex-row items-center gap-8 bg-gray-900'>
            <img
                src='profile.png'
                alt='profile'
            ...
            <div>
                ...
                <p className='text-gray-300 mb-4 max-w-xl'>
                    I’m Sifat — a self-taught developer and educator passionate about
